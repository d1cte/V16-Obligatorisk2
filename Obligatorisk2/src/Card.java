...
public abstract class Card implements Cloneable, Comparable<Card> {
	...
	public void setFullName(String fullName) {
		...
		// In case given name (firstName) is made up of several names, like "Tor
		// Even"
		String firstName = "";
	...
	public String toString() {
		...
		String information = String.format("%-20s %-20d %-20d %-20s", fullName, cardNumber, pinCode,
				((blockedCard) ? "Sperret" : "Aktiv"));
